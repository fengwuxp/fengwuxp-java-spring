...
public class ClazzUtils {
            ...
            while (urls.hasMoreElements()) {
                ...
                if (url != null) {
                    ...
                    if ("file".equals(protocol)) {
                        ...
                        //getAllClassSimpleNameByFile 获取简单类名
                        //getAllClassNameByFile 获取完整路径类名
                        result.addAll(getAllClassSimpleNameByFile(new File(path), showChildPackageFlag));
    ...
    private static List<String> getAllClassSimpleNameByFile(File file, boolean flag) {
        ...
        if(file.isFile()) {
            ...
            if(path.endsWith(CLASS_SUFFIX)) {
                ...
                String clazzName = path.substring(path.lastIndexOf(File.separator) + File.separator.length())
            ...
            if(listFiles != null && listFiles.length > 0) {
                ...
                for (File f : listFiles) {
                    if(flag) {
                        result.addAll(getAllClassSimpleNameByFile(f, flag));
                    } else {
